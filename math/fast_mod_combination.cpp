...
public:
	fast_mod_combination(const value_type& limit, const value_type& m)
...
//fast_mod_combination<long long> fmc(N, MOD);
//long long result = fmc.process(n, r);